...
// Main settings
define('SITE_NAME', '{{GAZELLE_NAME}}'); //The name of your site
define('NONSSL_SITE_URL', '{{GAZELLE_FQDN}}'); //The FQDN of your site
define('SSL_SITE_URL', '{{GAZELLE_FQDN}}'); //The FQDN of your site, make this different if you are using a subdomain for ssl
define('SITE_IP', '{{GAZELLE_IP}}'); //The IP address by which your site can be publicly accessed
define('SERVER_ROOT', '{{SERVER_ROOT}}'); //The root of the server, used for includes, purpose is to shorten the path string
define('ANNOUNCE_URL', '{{GAZELLE_ANNOUNCE}}'); //Announce URL
...
// Keys
define('ENCKEY', '{{GAZELLE_ENCRYPTION_KEY}}'); //Random key. The key for encryption
...
define('RSS_HASH', '{{GAZELLE_RSS_HASH}}'); //Random key. Used for generating unique RSS auth key.

// MySQL details
define('SQLHOST', '{{MYSQL_HOST}}'); //The MySQL host ip/fqdn
define('SQLLOGIN', '{{MYSQL_USER}}');//The MySQL login
define('SQLPASS', '{{MYSQL_PASSWORD}}'); //The MySQL password
define('SQLDB', '{{MYSQL_DATABASE}}'); //The MySQL database to use
define('SQLPORT', {{MYSQL_PORT}}); //The MySQL port to connect on
define('SQLSOCK', false);

// Memcached details
$MemcachedServers = array(
	// unix sockets are fast, and other people can't telnet into them
	array('host' => '{{MEMCACHED_HOST}}', 'port' => {{MEMCACHED_PORT}}, 'buckets' => 1),
);

// Sphinx details
define('SPHINX_HOST', '{{SPHINX_HOST}}');
define('SPHINX_PORT', {{SPHINX_PORT}});
define('SPHINXQL_HOST', '{{SPHINXQL_HOST}}');
define('SPHINXQL_PORT', {{SPHINXQL_PORT}});
...
// Ocelot details
define('TRACKER_HOST', '{{OCELOT_HOST}}');
define('TRACKER_PORT', {{OCELOT_PORT}});
define('TRACKER_SECRET', '{{OCELOT_SECRET}}'); // Must be 32 characters and match site_password in Ocelot's config.cpp
define('TRACKER_REPORTKEY', '{{OCELOT_REPORT_KEY}}'); // Must be 32 characters and match report_password in Ocelot's config.cpp
